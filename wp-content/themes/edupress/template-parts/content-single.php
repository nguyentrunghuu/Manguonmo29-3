	...
	<header class="ilovewp-page-intro ilovewp-page-inner">
		...
		<div class="ilovewp-meta-flex">
			...
			<p class="post-meta">
				...
				<?php if ( 1 == get_theme_mod( 'edupress_single_date', 1 ) ) { ?><span class="posted-on"><?php esc_html_e('Published','edupress'); ?> <time class="entry-date published" datetime="<?php echo get_the_date('c'); ?>"><?php echo get_the_date(); ?></time></span><?php } ?>
